...
ReactDOM.render(
  ...
  document.getElementById('js-modal-container'),
);
```
...
If you pass the prop `withUserModal` to the `Modal` component, it will include the default user profile system and it's routes.

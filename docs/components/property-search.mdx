...
import { TESTBedroomsSelect } from 'homeflowjs/search/bedrooms-select/bedrooms-select.component';
import { TESTPriceSelect } from 'homeflowjs/search/price-select/price-select.component';
...
<div style={{ paddingTop: '10px', paddingBottom: '30px'}}>
  <div style={{ display: 'inline-block', width: '40%', paddingRight: '5%' }}>
    <TESTPriceSelect type="min" setSearchField={() => null} reactSelect />
  </div>
  <div style={{ display: 'inline-block', width: '40%', paddingRight: '5%' }}>
    <TESTPriceSelect type="max" setSearchField={() => null} reactSelect />
  </div>
</div>
...
<div style={{ paddingTop: '10px', paddingBottom: '30px'}}>
  <div style={{ display: 'inline-block', width: '40%', paddingRight: '5%' }}>
    <TESTBedroomsSelect type="min" setSearchField={() => null} reactSelect />
  </div>
  <div style={{ display: 'inline-block', width: '40%', paddingRight: '5%' }}>
    <TESTBedroomsSelect type="max" setSearchField={() => null} reactSelect />
  </div>
</div>

...
See the section on [entry points](getting-started/entry-points.mdx) on how to use code-splitting to organise your JavaScript into page-specific bundles (this is probably the most important single optimization).
